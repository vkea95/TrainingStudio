...
public class Question {
    ...
    public static Edge createRandomEdge(String code) {
        ...
        Shape type = random.nextBoolean() ? Shape.INNER : Shape.OUTER;
    ...
    public static Edge[] createEdges(Piece[][] puzzle, int column, int row) {
        ...
        /* Get left edge */
        //判断下：如果是曾经生产出来的边，就根据邻接边算出来一个code===》这个解决了困扰我很久的问题了，不知道如何生成math的边
    ...
    public static boolean testSize(int size) {
        ...
        Puzzle puzzle = new Puzzle(pieces, size);
        puzzle.solve();
