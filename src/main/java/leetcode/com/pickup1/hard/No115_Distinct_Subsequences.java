 ...
 * of the characters without disturbing the relative positions of the remaining characters. (ie, "ACE"
 ...
 * i 0 0 0 0 0 0 3 3
 * t 0 0 0 0 0 0 0 3
 * 从这个表可以看出，无论T的字符与S的字符是否匹配，
 * dp[i][j] = dp[i][j - 1].就是说，假设S已经匹配了j - 1个字符，得到匹配个数为dp[i][j - 1].
...
public class No115_Distinct_Subsequences {
    public static void main(String[] args) {
        No115_Distinct_Subsequences obj = new No115_Distinct_Subsequences();
        obj.numDistinct("ccc", "c");
    }
