 ...
 * <p>
 * Follow up:
 * Could you solve it in-place? Remember that the board needs to be updated at the same time: You cannot updateHelper
 * some cells first and then use their updated values to updateHelper other cells.
